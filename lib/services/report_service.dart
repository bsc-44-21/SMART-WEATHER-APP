...
class ReportService {
  static Future<void> generateAndShareReport(PestDetectionModel detection, {bool isPremium = false}) async {
    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (pw.Context context) {
                      ...
                      children: [
                        pw.Column(
                          ...
                          children: [
                            ...
                            if (!isPremium)
                              pw.Text(
                                'Generated by Free Smart Weather App - Upgrade to Premium',
                                style: pw.TextStyle(
                                  fontSize: 10,
          ...
          // Watermark below all content if free
          if (!isPremium)
            pw.Positioned(
              bottom: 200,
              left: 50,
              child: pw.Transform.rotate(
                ...
                child: pw.Text(
                  ...
                  style: pw.TextStyle(
                    fontSize: 30,
                    color: PdfColors.grey300.shade(0.3),
                    fontWeight: pw.FontWeight.bold,
                  ),
                ),
              ),
